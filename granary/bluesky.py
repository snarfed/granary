...
# URL format for thumbnails generated by Bluesky's video CDN. not officially
# documented.
# https://github.com/bluesky-social/atproto/blob/328a4a86a999357eeae12a6da897bf686b4da88e/packages/bsky/src/views/util.ts#L97
# https://github.com/bluesky-social/atproto/blob/328a4a86a999357eeae12a6da897bf686b4da88e/packages/bsky/src/config.ts#L163
VIDEO_THUMBNAIL_URL = 'https://video.bsky.app/watch/{did}/{cid}/thumbnail.jpg'
  ...
  if type in as1.ACTOR_TYPES:
    ...
    for tag in tags:
      ...
      try:
        ...
        if start and as1.is_html(obj, 'content'):
    ...
    if repo_did and pds:
      if vid := obj['video']:
        ...
        ret = {
          ...
          'image': VIDEO_THUMBNAIL_URL.format(did=urllib.parse.quote(repo_did),
                                              cid=blob_cid(vid)),
    ...
    if repo_did and pds:
      ret = {
        ...
        'image': (obj.get('thumbnail')
                  or VIDEO_THUMBNAIL_URL.format(did=urllib.parse.quote(repo_did),
                                                cid=obj.get('cid'))),
        'displayName': obj.get('alt'),
      }
