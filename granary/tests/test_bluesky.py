...
class BlueskyTest(testutil.TestCase):
  ...
  def test_from_as1_actor_to_publication(self):
    self.assert_equals({
      ...
      'name': 'Alice',
      'description': 'hi there',
    }, from_as1(ACTOR_AS, out_type='site.standard.publication', domain='foo.com'))
  ...
  def test_from_as1_actor_to_publication_without_domain(self):
    with self.assertRaises(ValueError):
  ...
  def test_from_as1_article_to_document_truncates_long_tags(self):
    self.assert_equals({
      '$type': 'site.standard.document',
      'site': 'http://example.com',
      'path': '/post',
  ...
  def test_to_external_embed_html_content(self):
    self.assertEqual({
      '$type': 'app.bsky.embed.external',
      'external': {
        '$type': 'app.bsky.embed.external#external',
  ...
  def test_from_as1_sensitive_keyword(self):
    self.assert_equals({
      '$type': 'app.bsky.feed.post',
  ...
  def test_from_as1_sensitive_keyword_disabled(self):
    self.assert_equals({
      '$type': 'app.bsky.feed.post',
