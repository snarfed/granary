...
NSEC_URI_3 = 'nostr:nsec1652rh5r2n7czpud8xuvm2krf8f2hezqmy4kkf5nlmunjrcqhdteqtynrrs'
...
class NostrTest(testutil.TestCase):
  ...
  def test_from_as1_note_nip27_mentions(self):
    note = {
      'objectType': 'note',
      'author': PUBKEY_URI,
      'content': 'Hey foo and bar and baz',
      'content_is_html': False,
      'published': NOW_ISO,
      'tags': [{
        'objectType': 'mention',
    ...
    expected = {
      'kind': KIND_NOTE,
      'pubkey': PUBKEY,
      'content': f'Hey {NPUB_URI} and {NPUB_URI_2} and baz',
      'tags': [
        ['p', PUBKEY],
        ['t', 'a'],
        ['p', PUBKEY_2],
  ...
  def test_to_from_as1_article(self):
    id = 'd81d41c173115a08c1012d6ac041239f183e2afe06439a7542a323a308005e41'
    note = {
      'objectType': 'article',
      'id': 'http://art/icle',
      'author': PUBKEY_URI,
